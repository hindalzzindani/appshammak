...
import 'package:flutter_shammak_ecommerce/view/screen/product/product_details_screen.dart';
                                  ...
                                  children: [
                                    ...
                                    Row(children: [
                                      Text(
                                        ...
                                        Colors.white : Colors.orange, fontSize: Dimensions.FONT_SIZE_SMALL,fontWeight: FontWeight.bold),
                                      ),
                                      ...
                                      Text('(${megaProvider.flashDealList[index].reviewCount.toString() ?? 0})',
                                          style: robotoRegular.copyWith(
                                            fontSize: Dimensions.FONT_SIZE_SMALL,fontWeight: FontWeight.bold,
                                          )),
                                      Spacer(),
                          ...
                          children: [
                            ...
                            Row(children: [
                              Text(megaProvider.flashDealList[index].rating.length != 0 ?
                                double.parse(megaProvider.flashDealList[index].rating[0].average).toStringAsFixed(1) : '0.0',
                                style: robotoRegular.copyWith( fontSize: Dimensions.FONT_SIZE_SMALL,fontWeight: FontWeight.bold),
                              ),
                              Icon(Icons.star, color: Provider.of<ThemeProvider>(context).darkTheme ?
                              Colors.white : Colors.orange, size: 15),

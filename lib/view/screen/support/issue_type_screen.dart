...
import 'package:flutter_shammak_ecommerce/view/screen/support/add_ticket_screen.dart';

class IssueTypeScreen extends StatelessWidget {
  @override
  Widget build(BuildContext context) {
    List<String> issueTypeList = [
      getTranslated('Website Problem', context),
      getTranslated('Partner request', context),
      getTranslated('Complaint', context),
      getTranslated('Info inquiry', context),
    ];

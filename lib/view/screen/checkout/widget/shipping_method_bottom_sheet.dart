...
class _ShippingMethodBottomSheetState extends State<ShippingMethodBottomSheet> {
  route(bool isRoute, String message) async {
    if (isRoute) {
     ...
     Navigator.pop(context);
      ScaffoldMessenger.of(context).showSnackBar(SnackBar(content: Text(getTranslated('Failed', context)), backgroundColor: Colors.red));
    }
  }
  @override
  void initState() {
      ...
      child: Column(mainAxisSize: MainAxisSize.min, children: [
        ...
        Consumer<CartProvider>(
          builder: (context, order, child) {
            ...
            )  : Center(child: Text(getTranslated('No method available', context))) : Center(child: CircularProgressIndicator(valueColor: AlwaysStoppedAnimation<Color>(Theme.of(context).primaryColor)));
          },
        ),
      ]),
    );

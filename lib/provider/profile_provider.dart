...
import 'package:flutter_shammak_ecommerce/data/model/response/user_info_model.dart';
import 'package:flutter_shammak_ecommerce/data/repository/profile_repo.dart';
...
class ProfileProvider extends ChangeNotifier {
  ...
  void deleteAccountByID(String id, BuildContext context) async {
    _isLoading = true;
    notifyListeners();
    ApiResponse apiResponse = await profileRepo.deleteAccountByID(id);
    if (apiResponse.response != null && apiResponse.response.statusCode == 200) {

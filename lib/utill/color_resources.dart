...
class ColorResources {
  ...
  static Color getSellerTxt(BuildContext context) {
    return Provider.of<ThemeProvider>(context).darkTheme ? Color(0xFFF30B0B) : Color(
        0xFFFF92A6);
  }
  ...
  static Color getFloatingBtn(BuildContext context) {
    return Provider.of<ThemeProvider>(context).darkTheme ? Color(0xff8c4953) : Color(
        0xFFF57D7D);
  }
  ...
  static Color couponColor(BuildContext context) {
    return Provider.of<ThemeProvider>(context).darkTheme ? Color(0xFFFFC8C8) : Color(
        0xFFFFC8C8);
  }
  ...
  static const Color LIGHT_SKY_BLUE = Color(0xFFD32F2F);
  ...
  static const Color SELLER_TXT = Color(0xFFD32F2F);
  ...
  static const Map<int, Color> colorMap = {
    50: Color(0x106B1919),
    100: Color(0x206B1919),
    200: Color(0x306B1919),
    300: Color(0x406B1919),
    400: Color(0x506B1919),
    500: Color(0x606B1919),
    600: Color(0x706B1919),
    700: Color(0x806B1919),
    800: Color(0x906B1919),
    900: Color(0xff6b1919),
  };

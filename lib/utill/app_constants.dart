import 'package:flutter_shammak_ecommerce/data/model/response/language_model.dart';

class AppConstants {
  static const String APP_NAME = 'متـجر شماخ';
  ...
  static const String DELETE_USER_ACCOUNT_URI = '/api/v1/customer/useraccount?user_id=';
  ...
  // static const String DELETE_USER_ACCOUNT = 'delete_Account';
  ...
  static const String TOPIC = 'shammak';
